package cn.com.chengziapp.cloudvoicechat.commons.utils;
...
import cn.com.chengziapp.cloudvoicechat.commons.enums.TimeInterval;
...
public class DateUtils {
	  ...
	  public static long dateDiff(TimeInterval interval, Date date1, Date date2)
	  {
	    ...
	    case HOUR:
	      ...
	      time = calendar1.get(1) * 12;
	      calendar1.setTime(date1);
	      time -= calendar1.get(1) * 12;
	      calendar1.setTime(date2);
	      time += calendar1.get(2);
	      calendar1.setTime(date1);
	      result = time - calendar1.get(2);
	      break;
	    case MINUTE:
	      Calendar calendar11 = Calendar.getInstance();
	      calendar11.setTime(date2);
	      time = calendar11.get(1) * 52;
	      calendar11.setTime(date1);
	      time -= calendar11.get(1) * 52;
	      calendar11.setTime(date2);
	      time += calendar11.get(3);
	      calendar11.setTime(date1);
	      result = time - calendar11.get(3);
	      break;
	    case MONTH:
